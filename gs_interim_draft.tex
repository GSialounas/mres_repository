...
-&\sum_{K\in T}&\int_{K}q \nabla \cdot \textbf{u}_T. \nonumber
\end{eqnarray}
Next, we go through the same analysis steps we went through when we were doing the Stokes problem a-posteriori analysis to get the a-posteriori indicator for the mixed problem.  Namely,
