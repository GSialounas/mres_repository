...
\begin{theorem}{See \cite{verfurth2013posteriori}: \S4.10.3 Theorem 4.70}
...
\end{equation}
hold for all $K\in T$.  Both $c^*$ and $c$ depend on the shape parameter $C_T$.  The constant $c$ depends on the polynomial degrees of $\textbf{u}_T$, $p_T$ and $\textbf{f}_T$.
\end{theorem}

is such that, for the case when $\textbf{f}=\textbf{f}_T$,
\begin{eqnarray}
d
\end{eqnarray}
As is pointed out in \cite{verfurth2013posteriori} (see \S4.10.3: Theorem 4.70), this indicator
...
\end{equation}
If we enforce this condition then Propositions \ref{prop_well_pos_verf_saddle_1} and \ref{prop_well_pos_verf_saddle} can be used to establish the well-posedness of the mixed problem in the same way as for the variational formulation of the Stokes problem.   
