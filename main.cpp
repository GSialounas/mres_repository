...
namespace Step22
{
    ...
    private:
        ...
        void solve ();
        void compute_errors (const unsigned int refinement_cycle); // this method was compute_errors(bla bla) const: I removed the const.
...
//
    ...
    StokesProblem<dim>::output_results (const unsigned int refinement_cycle)  const
    {
        ...
        filename << "/Users/gs1511/dealii_out/solution-"
    ...
    template <int dim>
    void StokesProblem<dim>::compute_errors(const unsigned int refinement_cycle)
    {
        ...
        std::string error_filename = "/Users/gs1511/dealii_out/stokes_gs_error-adaptive.tex";
        std::ofstream error_table_file(error_filename.c_str());
        convergence_table.write_tex(error_table_file);
        
        std::string error_filename2 = "/Users/gs1511/dealii_out/stokes_gs_error-adaptive.text";
    ...
    void StokesProblem<dim>::run ()
    {
        ...
        convergence_table.set_precision("||p-p_h||_L2", 3);
        convergence_table.set_precision("||u-u_h||_L2", 3);
        convergence_table.set_precision("||u-u_h||_H1", 3);
        convergence_table.set_scientific("||p-p_h||_L2", true);
        convergence_table.set_scientific("||u-u_h||_L2", true);
        convergence_table.set_scientific("||u-u_h||_H1", true);
        convergence_table.set_tex_caption("cells", "\\# cells");
        convergence_table.set_tex_caption("dofs", "\\# dofs");
        convergence_table.set_tex_caption("||p-p_h||_L2", "@f$L^2@f$-error");
        convergence_table.set_tex_caption("||u-u_h||_L2", "@f$L^2@f$-error");
        convergence_table.set_tex_caption("||u-u_h||_H2", "@f$H^1@f$-error");
